...
/**
 * Created by Xi Chen on 2016/8/23.
 */
public class DatabaseProvider extends ContentProvider {
    ...
    public static final String AUTHORITY = "com.example.xichen.databasetest.provider";
    ...
    private MyDatabastHelper dbHelper;
    @Override
    public boolean onCreate() {
        dbHelper = new MyDatabastHelper(getContext(), "BookStore.db", null, 2);
        return true;
    }
